...
flowchart TD
    %% Power Sources
    PB["🔋 Portable Battery<br><sub>Power for Raspberry Pi</sub>"] --> |Power| RPI["🖥️ Raspberry Pi<br><sub>Central Processor</sub>"]
    CB["🔋 Car Battery<br><sub>Power for Motors</sub>"] --> |Power| MC["⚙️ Motor Control<br><sub>Controls Motors</sub>"]
